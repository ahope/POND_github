...
public class PointsDiaryTableHelper {
	...
	public static String COL_SOURCE = "source"; // 0 for user; 1 for
												// "from Food entry"

	public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME
			+ "( " + COL_ROWID + " integer primary key autoincrement, "
			+ COL_TIME_ENTERED + " text not null, " + COL_LOCATION_ID
			+ " integer, " + COL_FRUIT_VAL + " real, " + COL_FRUIT_WHOLE_VAL
			+ " real, " + COL_VEGGIE_VAL + " real, " + COL_VEGGIE_WHOLE_VAL
			+ " real, " + COL_GRAINS_VAL + " real, " + COL_GRAINS_WHOLE_VAL
			+ " real, " + COL_PROTEIN_VAL + " real, " + COL_DAIRY_VAL
			+ " real, " + COL_SODIUM_VAL + " real, " + COL_ALCOHOL_VAL
			+ " real, " + COL_SUGAR_VAL + " real, " + COL_FATS_VAL + " real, "
			+ COL_SOLID_FATS_VAL + " real, " + COL_OILS_VAL + " real, "
			+ COL_COMMENT + " text," + COL_IS_VALID + " integer," + COL_SOURCE
			+ " integer default 0" + ")";
